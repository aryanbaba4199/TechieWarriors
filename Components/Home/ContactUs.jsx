...
// import ContactPic from "../public/ContactPic.png";
      ...
      <div className="mb-8">
        ...
        <section className="flex md:flex-row flex-col justify-around items-center ">
          ...
          <div className="shadow-lg shadow-black p-8 flex flex-col justify-center items-center mt-4 hover:shadow-2xl hover:shadow-red-600">
            ...
            <p className="mt-4 text-blue-700">Kankarbagh, Patna, Bihar</p>
            <span className="flex gap-2">
        ...
        <section>
          <div className="flex p-8 md:px-24 px-4 justify-center items-center w-full mt-8 ">
            ...
            <div className="md:w-[30rem] w-full py-16 px-24 shadow-lg shadow-black hover:shadow-2xl hover:shadow-red-950 hover:border-2 hover:border-red-950">
              ...
              <div className="mt-6">
                <h2 className="text-lg">Enter Your Name</h2>
                <input
                  value={name}
                  placeholder="Enter Your Name"
                  onChange={(e) => setName(e.target.value)}
                  className="border-2 rounded-sm border-black w-60 px-2"
                />
              </div>
            ...
            <div className="translate-x-5">
              <img
                src="https://media.istockphoto.com/id/1483575338/vector/sql-technology-01.jpg?s=612x612&w=0&k=20&c=KSX2LXRVDtUHDZBRX4a_lhl3L50ki3HJ7t6DKBwFO3k="
